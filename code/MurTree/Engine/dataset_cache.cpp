...
void DatasetCache::StoreOptimalBranchAssignment(BinaryDataInternal& data, const Branch& b, const InternalNodeDescription& optimal_node, int depth, int num_nodes)
{
	...
	runtime_assert(RetrieveOptimalAssignment(data, b, depth, num_nodes).Error() == optimal_node.Error());
}
...
void DatasetCache::UpdateLowerBound(BinaryDataInternal &data, const Branch &branch, double lower_bound, int depth, int num_nodes)
{
	runtime_assert(depth <= num_nodes);
...
double DatasetCache::RetrieveLowerBound(BinaryDataInternal &data, const Branch &b, int depth, int num_nodes)
{
	runtime_assert(depth <= num_nodes);
